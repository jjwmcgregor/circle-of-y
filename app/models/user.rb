class User < ApplicationRecord
  ...
  validates :first_name, :second_name, :email, :country, presence: true
  validates :first_name, :second_name, :country, format: { with: /\A[a-zA-Z]+\z/, message: "No special characters or numbers, only letters" }
